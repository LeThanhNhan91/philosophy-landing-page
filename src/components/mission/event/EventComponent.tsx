    ...
    <div className="bg-[#2a2726] text-[#e8e2d9] min-h-screen font-serif p-4 sm:p-8 md:p-12">
      ...
      >
        ...
        <header className="text-center my-12">
          <h1
            className="text-7xl md:text-9xl font-bold text-[#c5b8a5]"
        ...
        <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="relative">
              <span className="absolute -top-4 -left-4 text-6xl text-[#c5b8a5] opacity-30">
                “
              </span>
        ...
        <section className="max-w-7xl mx-auto mt-16 space-y-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="space-y-4">
              <img
                src={event.gallery.image1}
                alt={event.gallery.caption1}
                className="w-full h-auto object-cover"
              />
              <p className="text-center text-sm italic text-[#c5b8a5]">
                {event.gallery.caption1}
              </p>
            </div>
            <div className="space-y-4">
              <img
                src={event.gallery.image2}
                alt={event.gallery.caption2}
                className="w-full h-auto object-cover"
              />
              <p className="text-center text-sm italic text-[#c5b8a5]">
                {event.gallery.caption2}
              </p>
            </div>
          </div>
          ...
          <div className="text-center py-12">
            <div className="relative max-w-3xl mx-auto">
              <span className="absolute -top-8 left-0 text-8xl text-[#c5b8a5] opacity-20">
                “
              </span>
              <p className="text-2xl md:text-3xl italic leading-relaxed">
                {event.finalQuote.text}
              </p>
              <span className="absolute -bottom-8 right-0 text-8xl text-[#c5b8a5] opacity-20">
                ”
              </span>
            </div>
            <p className="mt-6 text-lg text-[#c5b8a5]">
              -- {event.finalQuote.author} --
            </p>
          </div>
        </section>
      </motion.div>
