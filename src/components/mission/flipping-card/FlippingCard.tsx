      ...
      <div className="max-w-lg w-full">
                ...
                <div className="h-full flex flex-col items-center justify-center p-8">
                  ...
                  <div className="text-stone-200 text-lg leading-relaxed text-center mb-8 space-y-2" style={{ fontFamily: 'Inter' }}>
                    <p className="font-semibold text-stone-300">
                      Bác sĩ, giảng viên, IT hiện nay có phải là giai cấp công nhân hay không?
                    </p>
                    {/* <p>
        ...
        <div className="mt-6 text-center">
          <p className="text-stone-400 text-sm">
            💡 Chủ đề: <span className="text-stone-200 font-medium">Sứ mệnh lịch sử của giai cấp công nhân</span>
          </p>
        </div>
      </div>
    </div>
